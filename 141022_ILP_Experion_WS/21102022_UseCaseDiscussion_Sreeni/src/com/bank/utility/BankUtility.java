			...
			switch(mainChoice)											
			{
				...
				case 1:  
					if(customer==null) {
						...
						Service.depositMoney(customer);		//fuction that deposits money into selected account
					}
						break;
				case 2:
					if(customer==null) {
						...
						Service.withdrawMoney(customer);  //function that withdraws money from selected account
					}
				case 3: 
					if(customer==null) {
						System.out.println("Create An Account First");
						...
						Service.displayAccountDetails(accountList,customer); //function that displays the account details
					}
			}
			System.out.println("Do you want to continue : - ");
			choice = scanner.next().charAt(0);
